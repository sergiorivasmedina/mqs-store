    ...
    return (
        <Grid container spacing={3} sx={{ mb: '24px' }}>
            <Grid item xs={12} md={6}>
                <StyledButton onClick={() => clickMe('61b82064dbaa1314f8efdb9c')}>
            ...
            <Grid item xs={12} md={6}>
                <StyledButton onClick={() => clickMe('61b8207cdbaa1314f8efdb9e')}>
                    <StyledCard elevation={6}>
                        <ContentBox>
            ...
            <Grid item xs={12} md={6}>
                <StyledButton onClick={() => clickMe('61b8208adbaa1314f8efdba0')}>
                    <StyledCard elevation={6}>
                        <ContentBox>
            ...
            <Grid item xs={12} md={6}>
                <StyledButton onClick={() => clickMe('61b82094dbaa1314f8efdba2')}>
                    <StyledCard elevation={6}>
                        <ContentBox>
